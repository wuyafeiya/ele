<template>
  <div class="searchbar-06">
    <div class="searchbar-06-wrapper">
      <div class="searchbar-06-left">
        <div class="search-icon-wrapper">
          <span class="search-icon searchbar-06-icon">
      ...
      <div class="searchbar-06-center">
        <div class="searchbar-06-input-spacer"></div>

        <input
          type="text"
          class="searchbar-06-input"
          maxlength="2048"
          name="q"
          autocapitalize="off"
          autocomplete="off"
